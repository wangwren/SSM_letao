...
<title>乐淘商城-综合网购首选（JD.COM）-正品低价、品质保障、货到付款、配送及时、放心服务、轻松购物！</title>
<meta name="description" content="乐淘LT.COM-专业的综合网上购物商城，在线销售家电、数码通讯、电脑、家居百货、服装服饰、母婴、图书、食品、在线旅游等数万个品牌千万种优质商品。便捷、诚信的服务，为您提供愉悦的网上商城购物体验! ">
<meta name="Keywords" content="网上购物,网上商城,手机,笔记本,电脑,MP3,CD,VCD,DV,相机,数码,配件,手表,存储卡,乐淘商城">
<link href="/css/letao.css" rel="stylesheet"/>
...
<script type="text/javascript">
	//中广告位
	pageConfig.DATA_MScroll = ${ad2};
	//alert(pageConfig.DATA_MScroll);
...
<div class="mt">
<h2>乐淘快报</h2>
<div class="extra" clstag="homepage|keycount|home2013|11a"><a href="https://kuaibao.jd.com/?ids=151830718,152181675" target="_blank">更多快报&nbsp;&gt;</a></div>
</div>
<div class="mc">
	<ul>
		<c:forEach var="kb" items="${kb}">
			<li class="odd" clstag="homepage|keycount|home2013|11b1"><a href="${kb.url }" target="_blank" title="${kb.title}">${kb.title}</a></li>
		</c:forEach>
	</ul>
</div>
</div>
...
<div class="sm sm2 fore1 curr"  data-widget="tab-item" data-tag="100" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>空调</h3>
  </div>
...
<div class="sm sm2 fore2"  data-widget="tab-item" data-tag="101" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>数码相机</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore3"  data-widget="tab-item" data-tag="102" clstag="homepage|keycount|home2013|18e">
  <div class="smt">
    <h3>小家电</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore4"  data-widget="tab-item" data-tag="103" clstag="homepage|keycount|home2013|18f">
  <div class="smt">
    <h3>手机通讯</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore5"  data-widget="tab-item" data-tag="104" clstag="homepage|keycount|home2013|18g">
  <div class="smt">
    <h3>汽车五金</h3>
  </div>
  <div class="smc" data-widget="tab-content">
	...
	/* [   
		{
			...
			"height" : 180,
			"src" : "http://img12.3",
			"href" : "http://c.fa.jd.com/adclicksid=2&cid=601&aid",
			"alt" : ""
		}
	] */
