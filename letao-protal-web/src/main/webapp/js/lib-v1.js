...
!function() {
    ...
    a.jdCalcul = function(b) {
        var c = null, b = b.join(","), d = "http://qiang.jd.com/HomePageNewLimitBuy.ashx?callback=?&ids=" + b, e = "http://localhost:8086/", f = function(b) {
...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		//URL_Serv: "http://localhost:8082/category.js?callback=category.getDataService",
		URL_Serv: "http://localhost:8081/item/cat/all?callback=category.getDataService",
