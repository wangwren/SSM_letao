							...
							<div class="mc" id="order01">
								<dl>
									...
									<dd id="ordercount-waitPick"
										clstag="click|keycount|orderinfo|waitPick">待自提(0)</dd>
								</dl>
							</div>
						</div>
											...
											<tr id="track2538292730" oty="0,1,70" class="tr-td">
												<td>
													<div class="img-list">
														...
														<a href="http://www.taotao.com/item/${ orderItem.itemId}.html" class="img-box"
															clstag="click|keycount|orderinfo|order_product"
															target="_blank"> 
															<img title="${ orderItem.title}" width="50"
															height="50"
...
<form id="orderSearchForm" action="/ucenter/my/orders/search.html" method="post">
...
SEARCH.page = function(b,a){
	    ...
	    window.location = "/ucenter/my/orders.html?page="+b;
};

function OrderSearch(){
	$("#orderSearchForm [name=keyWords]").val($("#ip_keyword").val());
