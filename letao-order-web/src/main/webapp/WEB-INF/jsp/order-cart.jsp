...
<div class="w w1 header clearfix">
    <div id="logo"><a href="http://localhost:8082"><img src="/images/taotao-logo.gif" alt="乐淘商城"></a></div>
</div>

<form id="orderForm" class="hide" action="/order/create.html" method="post">
		<input type="hidden" name="paymentType" value="1"/><!-- 支付类型 -->
		...
		<input type="hidden" name="orderShipping.receiverName" value="王威人"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="18640905553"/>
		<input type="hidden" name="orderShipping.receiverState" value="辽宁省"/>
		<input type="hidden" name="orderShipping.receiverCity" value="大连市"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="庄河市"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="国奥花园"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">王威人</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">186****5553</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">辽宁省抚顺市</div>
						<div class="adr-m" limit="30">沈阳工学院</div>
...
<div class="shopping-list ABTest">
	<div class="goods-list">
     <!--配送方式-->
    <h4 class="vendor_name_h" id="0">商家：乐淘商城</h4>		         
		...
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">乐淘快递<i
						class='qmark-icon qmark-tip'
						data-tips='由乐淘公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
    ...
    <div class="ui-ceilinglamp checkout-buttons">
      ...
      <div class="sticky-wrap">
          ...
          <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
            部分商品货到付款方式：先由乐淘配送“提货单”并收款，然后厂商发货。
          </div>
        </div>
