...
<body id="mainframe">
	<div class="w w1 header clearfix">
		<div id="logo">
			<a href="/"><img src="/images/taotao-logo.gif" alt="乐淘商城"></a>
		</div>
	</div>
...
#refresh .m .fore4 a {
	...
	font-size: 12px
			...
			<ul class="m">
				<li class="fore1">您可以：稍后再试或联系客服186 **** ****
				</li>
				<li class="fore2">返回<a href="http://localhost:8082" target="_blank">乐淘首页</a></li>
